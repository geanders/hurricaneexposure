...
You can also map a binary variable of exposure for the communities that were exposed, based on a certain rainfall limit and distance limit:

```{r fig.width = 7, fig.height = 4}
map_3 <- map_rain_exposure(storm = "Floyd-1999", rain_limit = 50,
                           dist_limit = 100, 
                           days_included = c(-1, 0, 1))
plot(map_3)
```
